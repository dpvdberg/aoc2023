...
public class Day4Tests
{
    ...
    public string PartA8(string input)
    {
        return new Day4Solution(input).Solve(SolutionPart.PartA);
    }

    [TestCase("Card 2: 13 32 20 16 61 | 61 30 68 82 17 32 24 19", ExpectedResult = "2")]
    public string PartA2(string input)
    {
        return new Day4Solution(input).Solve(SolutionPart.PartA);
    }

    [TestCase("Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11", ExpectedResult = "0")]
    public string PartA0(string input)
    {
        return new Day4Solution(input).Solve(SolutionPart.PartA);
    }
    ...
    {
        return new Day4Solution(input).Solve(SolutionPart.PartB);
    }
}